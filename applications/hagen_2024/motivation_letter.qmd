...
Now, I am eager to apply these skills back to the field of learning analytics, where numerous application areas await. For instance, during my PhD, I worked on the COMPBASE project for three years. This project was significantly hindered by the challenge of matching similar learning outcomes—a task that large language models can now handle with ease.
